...
const i18n = {
    en: {
        ...
        'skills.desc': 'C/C++, Qt, LVGL, FreeRTOS, Linux, and more.',
        ...
        'km.title': 'Konica Minolta AccurioPress C5080/C5070',
        'km.company': 'FPT Software',
        'km.role': 'Embedded Software Engineer',
        ...
        'detail.tech': 'Technologies Used',
        'detail.sidebar.role': 'Role',
    ...
    vi: {
        ...
        'skills.desc': 'C/C++, Qt, LVGL, FreeRTOS, Linux và hơn thế nữa.',
        ...
        'footer.built': 'Xây dựng bằng HTML, CSS, JavaScript — Lưu trữ trên GitHub Pages',
        'km.title': 'Konica Minolta AccurioPress C5080/C5070',
        'km.company': 'FPT Software',
        'km.role': 'Kỹ Sư Phần Mềm Nhúng',
        ...
        'detail.achievements': 'Thành Tựu Chính',
        'detail.tech': 'Công Nghệ Sử Dụng',
        'detail.sidebar.role': 'Vai Trò',
...
function setLanguage(lang) {
    ...
    // Update placeholder images if on detail pages
    updateDetailPlaceholders(lang);

    // Toggle language-specific content blocks
    document.querySelectorAll('.lang-content').forEach(el => {
        const contentLang = el.getAttribute('lang');
        el.style.display = contentLang === lang ? 'block' : 'none';
    });
}
...
function updateDetailPlaceholders(lang) {
...
/* ====== Keyboard Shortcut: Ctrl+Shift+L to toggle language ====== */
